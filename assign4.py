...
def hanoi(n,A,C,B):
    ...
    hanoi(n-1,B,C,A)
hanoi(3,'tower 1','tower 2','tower3')
...
#a
print("display true if the function is callable: ",callable(fun(num1,num2)))

#b
print("display true if all values are non zero : ",bool(0 not in a))

#c
b = a + (4,5,6)
print("unfiltered tuple : ",b)
...
print("Hash value of the maximum value : ",hash(max(f)))
...
# creating object
student1 = Student("sahilpreet", 21104014)
